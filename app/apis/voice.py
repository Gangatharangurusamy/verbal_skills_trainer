...
#         os.remove(temp_file)  # Cleanup file
...
from langchain_groq import ChatGroq
from langchain_core.prompts import ChatPromptTemplate
from app.core.database import save_response  # ✅ Import database function
...
# ✅ Speech-to-Text API (Returns Text & Audio)
@router.post("/stt/")
